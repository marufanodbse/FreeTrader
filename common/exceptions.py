class FreetraderException(Exception):
    """
    Freetrader base exception. Handled at the outermost level.
    All other exception types are subclasses of this exception type.
    """


class OperationalException(FreetraderException):
    """
...
class DependencyException(FreetraderException):
    """
...
class StrategyError(FreetraderException):
    """
